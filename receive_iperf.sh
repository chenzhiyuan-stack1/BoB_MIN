...
runTestsOnModel() {
  ...
  ssh -p 2223 knw@202.120.36.216 "cd BoB_MIN && bash send_iperf.sh ${modelName} \"$video_path\" $height $width $fps \"$audio_path\""
...
video_params[bunny]="/home/min414/data2/extra_storage/output_3840x2160_60fps.yuv 2160 3840 60"
